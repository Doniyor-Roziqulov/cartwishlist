    ...
    return (
        <section className="pb-16">
            <div className="container px-[10px] lg:w-[1500px] lg:px-5 mx-auto">
                <div
                    className="bg-auto lg:bg-cover 2xl:bg-contain bg-no-repeat pt-[81px] pb-[80px] lg:pl-[80px] w-full flex justify-center lg:justify-start"
                    style={{ backgroundImage: `url(${herobg})` }}>
                    <div className="w-[280px] flex flex-col items-center lg:items-start sm:w-[600px]">
                        <h1 className="text-3xl xl:text-7xl font-bold mb-8 text-center md:text-5xl lg:text-start">
